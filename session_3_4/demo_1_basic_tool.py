...
def calculate_refund_eligibility(days_since_purchase:int, customer_tier:str) -> dict:
    """
    Decide whether a purchase is eligible for a refund based on the number of days
    since purchase and customer tier.
    ...
    """
    # Boundary check 1 - number of days since purchase must be a non-negative integer
    problems = []
    ...
    # Boundary check 2 - customer tier must be a valid tier
